...
# Get input lang setting from env variables(we used eng).
InputLanguage = env_vars.get("InputLanguage")

# Define Html for speech recognition.
...
# Replace the lang of html code with input lang from earlier.
HtmlCode = str(HtmlCode).replace("recognition.lang = '';", f"recognition.lang = '{InputLanguage}';")

# Write modified html code.
...
# Initialize the Chrome WebDriver using chromedevicemanager.
...
# Function to set assistant's status by writing a file.
...
def QueryModifier(Query):
    ...
    # Check if the query is a quesion and add question mark if needed.
...
def SpeechRecognition():
    ...
    # start sppeech recognition by clicking the start button.
    driver.find_element(by=By.ID, value="start").click()

    while True:
         try:
            # Get recognized text from html output element
            ...
            if Text:
                ...
                if InputLanguage.lower() == "en" or"en" in InputLanguage.lower():
                    ...
                    # If input lang is not english then make it!!
